...
class TestPicking(TransactionCase):
    ...
    def test_so_invoice(self):
        ...
        self.assertEqual(picking.move_line_ids.move_line_ids.lot_id, lot)
        picking.move_line_ids.move_line_ids.qty_done = 1.0
    ...
    def test_so_invoice2(self):
        ...
        picking = so.picking_ids
        self.assertEqual(picking.state, 'assigned')
        self.assertEqual(picking.move_line_ids.move_line_ids.mapped('lot_id'), lot1 + lot2)
        for line in picking.move_line_ids.move_line_ids:
            line.qty_done = 1.0
        picking.button_validate()
        self.assertEqual(picking.state, 'done')
    ...
    def test_po_invoice(self):
        ...
        for i, line in enumerate(picking.move_line_ids.move_line_ids):
